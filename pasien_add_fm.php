...
<table width="100%" style="border:0px;"  border="0" align="center">
    <tr> 
      <td colspan="2"><div align="center"><b>MASUKAN DATA ANDA</b></div></td>
    </tr>
    <tr> 
      <td>Nama</td>
      <td> 
    ...
    <tr>
      <td>Jenis Peternakan</td>
      <td><select name="cbopeternakan" id="cbopeternakan">
        <option value="0" selected="selected">- Jenis Peternakan -</option>
        <option value="Intensif">Intensif</option>
        <option value="Ektensif">Ektensif</option>
