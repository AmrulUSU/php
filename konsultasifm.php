...
<body>
<h2 class="art-postheader"><img src="images/postheadericon.png" width="28" height="27" alt="" />Pilih Gejala Yang Dialami</h2>
<div class="konten"><form  method="post" name="form" target="_self" action="?top=konsulperiksa.php">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bordercolor="#FFFFFF">
    <tr> 
      <td colspan="2"><div align="center"><strong>FORM DIAGNOSA PENYAKIT</strong> | PILIH GEJALA YANG DI ALAMI AYAM</div></td>
    </tr>
	<tr><td width="504" >
	...
	$query=mysql_query("SELECT * FROM gejala ORDER BY kd_gejala ASC") or die("Query Error..!" .mysql_error);
